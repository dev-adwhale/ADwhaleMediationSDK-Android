...
public class StyledTemplateBindingNativeMainActivity extends AppCompatActivity {

    private static final String LOG_TAG = StyledTemplateBindingNativeMainActivity.class.getSimpleName();

    private EditText etPlacementUid;
    private Button btnAdRequest;
    private Button btnShowAd;
    private RelativeLayout adViewRoot;
    private Switch switchLogger;
    private RadioButton radioSmall, radioMedium, radioFullscreen;
    private RadioButton radioDefault, radioDark, radioBrand, radioMinimal, radioFullStyle, radioCustomFont;
    ...
    private void initViews() {
        ...
        radioFullscreen = findViewById(R.id.radioFullscreen);
        ...
        radioFullStyle = findViewById(R.id.radioFullStyle);
        radioCustomFont = findViewById(R.id.radioCustomFont);
    ...
    private void setListener() {
        btnAdRequest.setOnClickListener(view -> {
            ...
            // 선택된 스타일 적용
            AdWhaleMediationNativeTemplateStyle style = getSelectedStyle();
     ...
     * 선택된 스타일 반환
     */
    private AdWhaleMediationNativeTemplateStyle getSelectedStyle() {
     ...
     * 기본 스타일 (스타일 없음)
     */
    private AdWhaleMediationNativeTemplateStyle createDefaultStyle() {
     ...
     * 다크 테마 스타일
     */
    private AdWhaleMediationNativeTemplateStyle createDarkStyle() {
        return new AdWhaleMediationNativeTemplateStyle.Builder()
                ...
                .withCallToActionBackgroundColor(new ColorDrawable(Color.parseColor("#4CAF50")))
                .build();
    }
     ...
     * 브랜드 테마 스타일
     */
    private AdWhaleMediationNativeTemplateStyle createBrandStyle() {
        return new AdWhaleMediationNativeTemplateStyle.Builder()
                .withMainBackgroundColor(new ColorDrawable(Color.parseColor("#E3F2FD")))
                ...
                .withCallToActionTypefaceColor(Color.WHITE)
                .withCallToActionBackgroundColor(new ColorDrawable(Color.parseColor("#FF5722")))
     ...
     * 미니멀 스타일
     */
    private AdWhaleMediationNativeTemplateStyle createMinimalStyle() {
        return new AdWhaleMediationNativeTemplateStyle.Builder()
                ...
                .withCallToActionBackgroundColor(new ColorDrawable(Color.TRANSPARENT))
                .build();
    }
     ...
     * 풀 스타일 (모든 요소 스타일링)
     */
    private AdWhaleMediationNativeTemplateStyle createFullStyle() {
        return new AdWhaleMediationNativeTemplateStyle.Builder()
                .withMainBackgroundColor(new ColorDrawable(Color.parseColor("#F5F5F5")))
                .withPrimaryTextTypefaceColor(Color.parseColor("#1A1A1A"))
                .withPrimaryTextSize(20f)
                .withPrimaryTextBackgroundColor(new ColorDrawable(Color.parseColor("#E8F5E8")))
                .withSecondaryTextTypefaceColor(Color.parseColor("#2E7D32"))
                .withSecondaryTextSize(16f)
                .withSecondaryTextBackgroundColor(new ColorDrawable(Color.parseColor("#F1F8E9")))
                .withTertiaryTextTypefaceColor(Color.parseColor("#424242"))
                .withTertiaryTextSize(14f)
                .withTertiaryTextBackgroundColor(new ColorDrawable(Color.parseColor("#FAFAFA")))
                .withCallToActionTypefaceColor(Color.WHITE)
                .withCallToActionTextSize(18f)
                .withCallToActionBackgroundColor(new ColorDrawable(Color.parseColor("#FF6B35")))
                .build();
    }
     ...
     * 커스텀 폰트 스타일
     */
    private AdWhaleMediationNativeTemplateStyle createCustomFontStyle() {
        Typeface boldTypeface = Typeface.DEFAULT_BOLD;
        Typeface italicTypeface = Typeface.create(Typeface.DEFAULT, Typeface.ITALIC);

        return new AdWhaleMediationNativeTemplateStyle.Builder()
                .withMainBackgroundColor(new ColorDrawable(Color.parseColor("#FFF8E1")))
                ...
                .withCallToActionTypefaceColor(Color.WHITE)
                .withCallToActionTextSize(16f)
                .withCallToActionBackgroundColor(new ColorDrawable(Color.parseColor("#FF9800")))
                .build();
    }
    ...
    private void createNativeAd() {
        ...
        adWhaleMediationNativeAdView.setAdWhaleMediationNativeAdViewListener(new AdWhaleMediationNativeAdViewListener() {
            ...
            public void onNativeAdLoaded() {
                ...
                Toast.makeText(getApplicationContext(), "스타일이 적용된 네이티브 광고 로드 성공!", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onNativeAdFailedToLoad(int errorCode, String errorMessage) {
                ...
                Toast.makeText(getApplicationContext(), "네이티브 광고 로드 실패: " + errorMessage, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onNativeAdShowFailed(int errorCode, String errorMessage) {
                Log.e(LOG_TAG, ".onNativeAdFailedToLoad(" + errorCode + ", " + errorMessage + ")");
                Toast.makeText(getApplicationContext(), ".onNativeAdFailedToLoad(statusCode:" + errorCode + ", message:" + errorMessage + ")", Toast.LENGTH_SHORT).show();
            }
    ...
    private void loadFullscreenNativeAdDialog() {
        ...
        fullscreenAdView.setAdWhaleMediationNativeAdViewListener(new AdWhaleMediationNativeAdViewListener() {
            ...
            public void onNativeAdLoaded() {
                ...
                isAdLoaded = true;
                btnShowAd.setEnabled(true);
                Toast.makeText(getApplicationContext(), "FULLSCREEN 스타일 네이티브 광고 로드 성공!", Toast.LENGTH_SHORT).show();
            }
    ...
    private void showFullscreenNativeAdDialog() {
        ...
        closeButton.setBackgroundColor(0xFF1976D2);
        ...
        adContainer.setBackgroundColor(0xFFF0F0F0);
